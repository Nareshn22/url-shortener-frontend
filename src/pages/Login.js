      ...
      <div className="card border-0 p-5 shadow-lg position-relative overflow-hidden" style={{ 
        ...
        <div className="position-relative">
          <div className="text-center mb-4">
            ...
            <h2 className="fw-bold text-dark mb-1" style={{ letterSpacing: '-0.75px' }}>Welcome Back</h2>
            <p className="text-muted small">Log in to safely manage your active short codes</p>
          </div>
          ...
          <p className="mt-4 text-center small text-muted mb-0">
            Don't have an account? <Link to="/signup" className="text-decoration-none fw-bold text-primary ms-1">Sign up free</Link>
          </p>
        </div>
      </div>
    </div>
